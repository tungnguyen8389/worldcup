...
<div class="card party-fund-card" style="margin-bottom: 25px; background: #ffffff; border: 1px solid rgba(0, 0, 0, 0.08); box-shadow: 0 10px 30px rgba(0, 0, 0, 0.12); color: #1f2937;">
    <div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 15px; margin-bottom: 15px;">
        <div style="display: flex; align-items: center; gap: 12px;">
            <div class="hotpot-icon-wrapper" style="font-size: 28px; color: #ef4444; animation: float 3s ease-in-out infinite;">
                <i class="fa-solid fa-fire-burner"></i>
            </div>
            <div>
                <h3 style="color: #111827; font-family: 'Outfit'; font-weight: 800; font-size: 17px; margin: 0; text-transform: uppercase; letter-spacing: 0.5px;">NỒI LẨU TIÊN TRI - QUỸ LIÊN HOAN NHÓM</h3>
                <p style="color: #4b5563; font-size: 12.5px; margin: 2px 0 0 0; font-weight: 500;">Góp sức cho nồi lẩu World Cup thêm tôm thịt!</p>
            </div>
        </div>
    ...
    <div style="margin-bottom: 20px;">
        ...
        <div class="progress-bar-container" style="width: 100%; height: 11px; background: #f3f4f6; border-radius: 10px; overflow: hidden; border: 1px solid rgba(0,0,0,0.06);">
            <div class="progress-bar-fill" style="width: <?php echo $percent; ?>%; height: 100%; background: linear-gradient(90deg, #f59e0b 0%, #10b981 100%); border-radius: 10px; box-shadow: 0 2px 6px rgba(16, 185, 129, 0.2);"></div>
        </div>
    </div>

    <!-- Danh sách Mạnh Thường Quân -->
    <div style="border-top: 1px solid #f3f4f6; padding-top: 15px;">
        <div style="font-size: 12.5px; font-weight: 800; color: #111827; text-transform: uppercase; margin-bottom: 12px; display: flex; align-items: center; gap: 6px; letter-spacing: 0.5px;">
            <i class="fa-solid fa-crown" style="color: #f59e0b;"></i> Bảng Danh Dự Mạnh Thường Quân (Đóng Góp Nồi Lẩu)
        </div>
